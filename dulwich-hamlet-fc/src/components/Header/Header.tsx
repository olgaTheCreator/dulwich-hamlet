...
const Header = () => {
  ...
  return (
    <div
      className={`bg-player bg-${theme}-background/70 bg-cover bg-top relative h-screen w-full flex flex-col ${
        scrolled
          ? "bg-clip-text z-20 backdrop-blur-lg bg-blend-screen backdrop-saturate-200 "
          : ""
      }`}
    >
      <motion.div
        ...
        className={` w-full relative h-max place-self-center flex flex-col my-28 transition-all duration-300 z-20 ${
